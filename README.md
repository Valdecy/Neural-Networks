...
* Layers: List with number of hidden layers and quantity of neurons. Ex: layers[0] = Perceptron, layers[1,7] = Two hidden layers, the first one with 1 neuron and the second one with 7 neurons.
